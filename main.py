...
Label(root,text="hours",font="arial 12",bg="#000",fg="#fff").place(x=107,y=200)
Label(root,text="min",font="arial 12",bg="#000",fg="#fff").place(x=229,y=200)
Label(root,text="sec",font="arial 12",bg="#000",fg="#fff").place(x=349,y=200)
...
button=Button(root,text="Start",bg="#ea3558",bd=0,fg="#fff",width=20,height=2,font="arial 10 bold",command=timer)
button.pack(padx=5,pady=40,side=BOTTOM)

Image1=PhotoImage(file="english.png")
button1=Button(root,image=Image1,bg="#000",bd=0,command=english)
button1.place(x=7,y=300)

Image2=PhotoImage(file="maths.png")
button2=Button(root,image=Image2,bg="#000",bd=0,command=maths)
button2.place(x=137,y=300)
Image3=PhotoImage(file="phisics.png")
button3=Button(root,image=Image3,bg="#000",bd=0,command=phisics)
